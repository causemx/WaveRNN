...
This Repo is fork by [fatchord/WaveRNN](https://github.com/fatchord/WaveRNN) in oder to train Tacotron model 
from own voice and apply in content generated by GPT3/4.
